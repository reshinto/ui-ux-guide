...
import CreatingVariantsText from "../../assets/svgs/CreatingVariantsText.svg";
import * as texts from "../../shared/constants/creatingVariants";
...
function CreatingVariantsScreen() {
  const {params} = useRoute<ScreenRouteProps<"CreatingVariants">>() as any;
  ...
  return (
    <View style={styles.container}>
      <ScreenScrollableWrapper>
        <ScreenTitle svgScreenTitle={CreatingVariantsText} />
        <ScreenSection
...
export default CreatingVariantsScreen;
